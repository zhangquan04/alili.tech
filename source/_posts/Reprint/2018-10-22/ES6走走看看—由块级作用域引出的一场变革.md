...
<p><span class="img-wrap"><img data-src="/img/bVbgyJO?w=2378&amp;h=560" src="https://static.segmentfault.com/v-5bbf1b3b/global/img/squares.svg" alt="var 声明的a，在右侧 global 里面" title="var 声明的a，在右侧 global 里面" style="cursor: pointer;"></span></p>
<p>另一方面规定，let命令、const命令、class命令声明的全局变量，不属于顶层对象的属性。</p>
<p><span class="img-wrap"><img data-src="/img/bVbgyJP?w=2396&amp;h=666" src="https://static.segmentfault.com/v-5bbf1b3b/global/img/squares.svg" alt="图片描述" title="图片描述" style="cursor: pointer;"></span></p>
