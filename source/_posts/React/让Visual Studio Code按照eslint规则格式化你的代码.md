...
1. 在Visual Studio Code 安装 ESLint插件
2. widnows 点击 文件>首选项>设置 / mac 点击Code>首选项
3. 搜索 eslint.autoFixOnSave, 找到之后修改为 true

重启你的Visual Studio Code,当你打开代码文件的后,直接保存文件.
代码会自动格式化成ESLint规定的格式.大大的提高了开发效率,并且统一了代码规范
